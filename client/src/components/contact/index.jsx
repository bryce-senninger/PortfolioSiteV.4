    ...
    <>
      ...
      <div class="">
        <div class="jumbotron bioPageJumbo">
          <p class="headP">
            I am a full-stack web developer specialized in HTML, CSS,
            Javascript, React, Node.js, Express, MySQL, and MongoDB.
          </p>
          <p>
            ...
            <img
              class="selfie"
              src="../assets/156906134636719205ds.jpg"
              alt="Bryce"
            />
          ...
          <p>
            ...
            HTML and CSS in the fall of 2018. Immediately I fell in love with
            the aspects of problem solving and implemenation of logic. Knowing
            that this was the path that I wanted to take, I decided to enroll in
            the Full-Stack Web Development Bootcamp offered through the
            University of Utah.
          </p>
          <p>
